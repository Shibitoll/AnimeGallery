...
class AnimeSerializer(serializers.ModelSerializer):
    # Додаємо default або required=False, щоб пусті значення не викликали помилку 400
    userRating = serializers.DecimalField(source='user_rating', max_digits=3, decimal_places=1, required=False, default=0.0)
